...
function StudentAttendanceHistory({ studentId }) {
  ...
  const handleShowAttendance = async () => {
    try {
      const response = await axios.get(`${BaseUrl}student/attendance-history/student`, {
  ...
  return (
    <PageWrapper>
      <div className="p-4 md:p-6 bg-black min-h-screen text-yellow-400 rounded-xl shadow-lg mt-12">
        <h2 className="text-xl md:text-2xl font-bold mb-6 text-yellow-300 border-b border-yellow-600 pb-2">
